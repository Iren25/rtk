...
// - пишем api -> создаем файл slice -> initial state -> asynk thunk ->
// -> сам slice -> добавляем в store
// -> создаем компонент и используем usAppSelector - это своего рода геттер
// и useAppDispatch - это сеттер

// eslint-disable-next-line import/prefer-default-export
export const loadProducts = createAsyncThunk(
	'products/loadProducts', // type нашего action
	() => api.getAll() // payload - в данном случае Product[] - то,
	// что возвращает api с раскрытым промисом
);
...
export const { changeToggleStatus, chooseFavoriteProduct } =
	productsSlice.actions; // экспорт функций reducer
